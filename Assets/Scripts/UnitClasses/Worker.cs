...
/// </summary>
// TODO: ПЕРЕИМЕНОВАТЬ КЛАСС В REDNECK
public class Worker: Unit
{
    ...
    public Worker(Vector3Int coordinates, int startAP, GameObject workerObject):base(coordinates, startAP)
    {
        SetCharacteristics();
        currentAP = startAP;
        unitObject = workerObject;
