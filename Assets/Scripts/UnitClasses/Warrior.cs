...
public class Warrior : Unit
{
    ...
    public Warrior(Vector3Int coordinates, GameObject warriorObject) : base(coordinates)
    {
        // Устанавливаем характеристики юнита-война
        SetCharacteristics();
        unitObject = warriorObject;
    }
    ...
    public Warrior(Vector3Int coordinates, int startAP, GameObject warriorObject) : base(coordinates, startAP)
    {
        SetCharacteristics();
        currentAP = startAP;
        unitObject= warriorObject;
